...
namespace EvaFrontier
{
    ...
    class LoadingScreen : GameScreen
    {
        ...
        private List<Texture2D> texturesToDisplay;
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (otherScreensAreGone)
            {
                ...
                if (timer >= 1) {
                    timer = 0f;
                    currentTexture = (currentTexture + 1)%texturesToDisplay.Count;
                }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (loadingIsSlow)
            {
                ...
                spriteBatch.End();*/
                spriteBatch.Begin();
                spriteBatch.Draw(texturesToDisplay[currentTexture], Vector2.Zero, color);
                spriteBatch.End();
            }
        }
